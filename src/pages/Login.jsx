...
const Login = () => {
  ...
  return (
    <div className="flex flex-col py-5 sm:py-10 gap-5  w-[80%] sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[40%] bg-slate-100 mx-auto items-center">
      <h1 className="text-center text-2xl sm:text-3xl font-bold">Login</h1>
      <form
        className="flex flex-col gap-3 sm:gap-5 w-[80%] sm:w-2/3 p-1 sm:p-2"
      ...
      >
        ...
        <div className="flex flex-col gap-2 sm:gap-3 justify-between">
          ...
          <input
            ...
            id="email"
            ref={emailRef}
            className="bg-gray-200 h-9 p-2 text-lg sm:text-xl"
          />
        </div>
        <div className="flex flex-col gap-2 sm:gap-3 justify-between">
          <label
